<aside class="main-sidebar">
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<li id="accountLink" class="treeview">
			<a 	href="/CodeBigBroSub/framework/account"> <i class="fa fa-meh-o"></i>&nbsp;
					Account 
					<!-- 
					<span id="accountLinkLabel"
					class="label label-default pull-right labelSpan">Not started</span>
					-->
					<i id="accountLinkLabel" class="fa fa-circle-o text-grey pull-right"></i>
			</a></li>

			<li class="header">Crawler</li>
			...
			<li class="header">User Studies</li>
			...
			<li class="treeview"><a href="/CodeBigBroSub/framework/newIndex">
					<i class="fa fa-trash"></i>&nbsp; Start a New Search
			</a></li>

			<li class="header">LABELS</li>
			<li><a href="#"><span>Task Aborted</span><i class="fa fa-circle-o text-red pull-right"></i></a></li>
			<li><a href="#"><span>Not Yet Started</span><i class="fa fa-circle-o text-grey pull-right"></i></a></li>
			<li><a href="#"><span>Task Running</span><i class="fa fa-circle-o text-yellow pull-right"></i></a></li>
			<li><a href="#"><span>Task Complete</span><i class="fa fa-circle-o text-green pull-right"></i></a></li>
			<li><a href="#"><span>No Content</span><i class="fa fa-circle-o text-aqua pull-right"></i></a></li>
			
			<!-- Test zone
			<li><a href="#"><span>Teal</span><i class="fa fa-circle-o text-teal pull-right""></i></a></li>
			<li><a href="#"><span>Olive</span><i class="fa fa-circle-o text-olive pull-right""></i></a></li>
			<li><a href="#"><span>Maroon</span><i class="fa fa-circle-o text-maroon pull-right""></i></a></li>
			<li><a href="#"><span>Lime</span><i class="fa fa-circle-o text-lime pull-right""></i></a></li>
			 -->

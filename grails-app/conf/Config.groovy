...
//        console name:'stdout', layout:pattern(conversionPattern: '%c{2} %m%n')
		...
		//new appender
		file name:'file',file:'D:/fyplog/jos.log',layout: pattern(conversionPattern: '[%d{HH:mm:ss}] %X{sessionId} %p %c{1} - %m%n')
		
		appender new DailyRollingFileAppender(
			name:"dailyAppender",
			datePattern:"'.'yyyy-MM-dd",
			fileName:'D:/fyplog/weibostudy.log',
			layout:pattern(conversionPattern: '[%d{HH:mm:ss}] %X{sessionId} %p %c{1} - %m%n')	
		)
    }
